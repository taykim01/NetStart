            ...
            return (
                <div style={{ width: "100%" }}>
                    <ItemsCarousel
                        ...
                        activeItemIndex={activeItemIndex}
                        numberOfCards={1}
                        leftChevron={<div style={{ transform: "scale(0.7)" }}><Button type="arrow_button" direction="left" /></div>}
                        rightChevron={<div style={{ transform: "scale(0.7)" }}><Button type="arrow_button" direction="right" /></div>}
                        outsideChevron={false}
                        infiniteLoop={false}
                        firstAndLastGutter={false}
                        chevronWidth={40}
                    >
                        ...
                        {/* section 1 */}
                        <div className="mobile_strengths_page">
                            <div className="h4 grey-900">
                                처음부터 끝까지,
                                <br />신경 쓸 일 없는 웹 제작
                            </div>
                            <div className="vf gap12">
                                ...
                                <div className="pages_continuous-slider-track">
                                    {
                                        services.map(
                                            service => <div key={service} className="pages_animation h6">{service}</div>
                                        )
                                    }
                                </div>
                            </div>
                        ...
                        <div className="mobile_strengths_page">
                            ...
                            <div style={{ transform: "scale(1.2)" }} className="w100 vf ca"><LoadingAnimation /></div>
                            <div className="vf gap24">
                                <div className="p4 grey-700">웹 제작, 오래 걸리지 않아요. 빠르게 서비스를 시작해보세요.</div>
                                <Button text="제작하러 가기" onClick={() => scrollTo(refS2)} />
                            </div>
                        </div>
                        ...
                        {/* section 3 */}
                        <div className="mobile_strengths_page">
                            <div className="h4 grey-900">꾸준한 유지보수</div>
                            <div style={{ margin: "0 auto", transform: "scale(0.5)" }}>
                                <Laundry />
                            </div>
                            <div className="vf gap24">
                                <div className="p4 grey-700">
